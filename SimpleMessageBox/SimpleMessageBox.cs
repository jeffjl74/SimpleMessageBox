...
namespace SimpleMessageBoxes
{
    ...
    public partial class SimpleMessageBox : Form
    {
        ...
        /// <summary>
        /// Set enableDebug=true to Console.Writeline info during the richTextBox1_ContentsResized() method 
        /// </summary>
        ...
        private void richTextBox1_ContentsResized(object sender, ContentsResizedEventArgs e)
        {
            ...
            if (enableDebug)
                Console.WriteLine($"Exit {sizePassDebug} - newRect height:{e.NewRectangle.Height}, form height:{this.Height}, rtf height:{richTextBox1.Height} Changed:{isAdjusted}, diff:{diff}");
        }
